 ...
 */
package org.fhcrc.cpl.viewer.feature.filehandler;
    ...
    implements FeatureSetFileHandler
{
            ...
            throws IOException
    {
        ...
        List<org.fhcrc.cpl.viewer.feature.Feature> msInspectFeatures =
                new ArrayList<org.fhcrc.cpl.viewer.feature.Feature>(peakListListener.getFeatures().size());
        ...
        for (org.systemsbiology.apmlparser.v2.datatype.Feature apmlFeature: peakListListener.getFeatures())
        {
            ...
            org.fhcrc.cpl.viewer.feature.Feature msInspectFeature =
        ...
        result.setFeatures(msInspectFeatures.toArray(
               new org.fhcrc.cpl.viewer.feature.Feature[msInspectFeatures.size()]));
     ...
     * @return
     */
    public org.fhcrc.cpl.viewer.feature.Feature
              createMsInspectFeatureFromAPMLFeature(
            org.systemsbiology.apmlparser.v2.datatype.Feature apmlFeature)
    {
        org.fhcrc.cpl.viewer.feature.Feature result =
                 new org.fhcrc.cpl.viewer.feature.Feature();
...
//        dp.setVersion((String)featureSet.getProperty("revision"));
        ...
        org.fhcrc.cpl.viewer.feature.Feature[] msInspectFeatures =
        ...
        for (org.fhcrc.cpl.viewer.feature.Feature msInspectFeature : msInspectFeatures)
        {
            org.systemsbiology.apmlparser.v2.datatype.Feature apmlFeature =
